      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              to={ROUTES.HOME}
              className="flex items-center gap-3 text-gray-900 dark:text-white hover:text-primary-600 dark:hover:text-primary-400 transition-colors"
            >
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-3 relative" ref={dropdownRef}>
              ...
              {/* Dropdown Menu */}
              {isDropdownOpen && (
                <div className="absolute right-0 top-12 w-56 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 py-1 z-50">
                  {/* User info */}
                  ...
                  <div className="border-t border-gray-200 dark:border-gray-700 py-1">
                    <button
                      ...
                      className="flex items-center gap-3 w-full px-4 py-2 text-sm text-danger-600 dark:text-danger-400 hover:bg-danger-50 dark:hover:bg-danger-900/20 transition-colors"
                    >
                      <svg
                        className="w-4 h-4"
                        fill="none"
